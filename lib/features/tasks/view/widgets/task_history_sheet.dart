...
import 'package:app_front/features/tasks/view/widgets/history_tile.dart';
import 'package:easy_localization/easy_localization.dart';
import 'package:flutter/material.dart';
import 'package:provider/provider.dart';

class TaskHistorySheet extends StatefulWidget {
  const TaskHistorySheet({super.key});
...
class _TaskHistorySheetState extends State<TaskHistorySheet> {
  ...
  Future<void> _load() async {
    try {
      await context.read<TasksProvider>().fetchHistory(refresh: true);
  ...
  void _onScroll() {
    context.read<TasksProvider>().loadMoreHistory(_controller).catchError((
      Object error,
    ) {
                  ...
                  return RefreshIndicator(
                    ...
                    child: ListView.separated(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return TaskHistoryTile(item: provider.history[index]);
                      },
                    ),
                  );
                },
